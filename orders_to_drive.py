...
def main():
    ...
    # 3. GENERATE REPORT (Order Status Report Detail - OMS)
    payload = {
        "paramMap": {
            "fulfillmentLocations": ["1101210185", "1101214370", "1101205510"],
            "client": ["1101201064", "1101210390"],
            "Perspective": ["Market Place Perspective"],
            "pickordergroup": ["ALL"], "prepackstaginglocation": ["ALL"], "retryCount": ["ALL"],
            "OrderCreatedFrom": [start_utc], "OrderCreatedTo": [end_utc],
            "RequiredByFrom": [], "RequiredByTo": [], "LastUpdatedFrom": [], "LastUpdatedTo": [],
            "ChannelOrderID": [], "SystemOrderID": [], "ParentOrderID": [], "WmsOrderFrom": [], "WmsOrderTo": [],
            "OrderStatus": [], "WmsUpdatedFrom": [], "WmsUpdatedTo": [], "salesChannel": [],
            "ReservationPool": [], "BusinessType": [], "PickOrderGroupCode": [], "SLAStatus": [],
            "PrePostPackStagingLocation": [], "finalResolution": []
        },
